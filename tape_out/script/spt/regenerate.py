...
design_name = "sptree"  # Name of your design

print(f"Regenerate {design_name}")

# Export the design to gds
my_pdks.GeneralizedSplitterTree(n_levels=2).Layout().write_gdsii(os.path.join(output_folder, design_name + ".gds"))

# Extract file info and export it
si=my_pdks.GeneralizedSplitterTree(n_levels=2).Layout().size_info()
