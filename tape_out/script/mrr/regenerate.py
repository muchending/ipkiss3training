...
design_name = "mrr"  # Name of your design

print(f"Regenerate {design_name}")

# Export the design to gds
my_pdks.microring().Layout().write_gdsii(os.path.join(output_folder, design_name + ".gds"))

# Extract file info and export it
si = my_pdks.microring().Layout().size_info()
