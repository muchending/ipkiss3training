...
class Test_TunableDelayLine(ComponentReferenceTest):
    @pytest.fixture
    def component(self):
        from pteam_library_si_fab.all import TunableDelayLine

        return TunableDelayLine(name="TunableDelayLineDefault")
